...
# # ============================================
# # RAG SETUP — pgvector (Lazy Loading)
# # ============================================

# # Lazy loading — startup pe load nahi hoga, sirf jab pehli baar use hoga
...
#     vectorstore = PGVector.from_documents(
#         documents=splits,
#         embedding=get_embedding_model(),  # Lazy load
#         collection_name=collection_id,
#         connection=DATABASE_URL,
...
# def load_pgvector_store(collection_id: str):
#     vectorstore = PGVector(
#         embeddings=get_embedding_model(),  # Lazy load
#         collection_name=collection_id,
#         connection=DATABASE_URL,
#     )
#     return vectorstore
...
#         "question": RunnablePassthrough(),
#     })
#     chain = parallel | prompt | get_llm() | StrOutputParser()  # Lazy load
#     return chain.invoke(question)
...
#     print("="*55)
#     print("Vector Store: pgvector (Supabase PostgreSQL)")
#     print("Embedding model: Lazy loaded (loads on first use)")
#     print("\nWorkflow:")
#     print("1. Register: POST /register")
#     print("2. Login:    POST /token  → Bearer token milega")
#     print("3. Upload:   POST /upload  (Bearer token + collection_name)")
...
@app.get("/ui")
async def serve_ui():
    return FileResponse("templates/rag4.html")
...
def query_rag(vectorstore, question: str) -> str:
    ...
    chain = parallel | prompt | get_llm() | StrOutputParser()
    return chain.invoke(question)
